// ──────────────────────────────────────────────────────────────────────────
// VERBATIM — origin: openclaw/src/gateway/auth-mode-policy.ts (whole file)
//
// STEP 2 (guard): if BOTH token and password are configured but no explicit
// gateway.auth.mode is set, refuse to start (ambiguous). Called before the
// server binds, so a misconfigured auth surface fails fast.
// ──────────────────────────────────────────────────────────────────────────
